...
: DynamicTestCaseDataRowSource(argsCode)
{
    ...
    public IEnumerable<TestCaseData>? GetBirthDayConstructorValidArgs(string? testMethodName, ArgsCode? argsCode = null)
    {
    ...
    // Valid 'string name' parameter should be declared and initialized
    // within the test method.
    public IEnumerable<TestCaseData>? GetCompareToArgs(string? testMethodName, ArgsCode? argsCode = null)
    {
    ...
    // within the test method.
    public IEnumerable<TestCaseData>? GetBirthDayConstructorInvalidArgs(string? testMethodName,
