...
: DynamicTheoryTestDataHolder(argsCode)
{
    ...
    public IEnumerable<ITheoryTestDataRow>? GetBirthDayConstructorInvalidArgs(
    ...
    public IEnumerable<ITheoryTestDataRow>? GetBirthDayConstructorValidArgs(string? testMethodName, ArgsCode? argsCode = null)
    {
    ...
    public IEnumerable<ITheoryTestDataRow>? GetCompareToArgs(string? testMethodName, ArgsCode? argsCode = null)
    {
