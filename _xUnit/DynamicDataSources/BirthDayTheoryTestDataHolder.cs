...
: DynamicTheoryTestDataHolder(argsCode)
{
    ...
    public TheoryTestData<TestData<DateOnly>>? GetBirthDayConstructorValidArgs(ArgsCode? argsCode = null)
    {
        ...
        return GetTheoryTestData<TestData<DateOnly>>(argsCode);
    ...
    // within the test method.
    public TheoryTestData<TestDataThrows<ArgumentException, string>>? GetBirthDayConstructorInvalidArgs(ArgsCode? argsCode = null)
    {
        ...
        return GetTheoryTestData<TestDataThrows<ArgumentException, string>>(argsCode);
    ...
    // Valid 'string name' parameter should be declared and initialized
    // within the test method.
    public TheoryTestData<TestDataReturns<int, DateOnly, BirthDay>>? GetCompareToArgs(ArgsCode? argsCode = null)
    {
        ...
        return GetTheoryTestData<TestDataReturns<int, DateOnly, BirthDay>>(argsCode);
